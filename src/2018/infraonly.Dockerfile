...
ADD --chown=latex:latex 2018/texlive.profile /texlive/texlive.profile
RUN mkdir /src \
...
RUN cd /texlive/ \
    ...
    && cd install-tl-*/ \
    && ./install-tl -profile=/tmp/texlive/texlive.profile -repository=ftp://tug.org/historic/systems/texlive/2018/tlnet-final/ \
    && cd /texlive \
