...
ADD --chown=latex:latex 2020/texlive.profile /texlive/install/texlive.profile
RUN mkdir /src \
...
RUN cd /texlive/install/ \
    ...
    && cd install-tl-*/ \
    && ./install-tl -profile=/texlive/install/texlive.profile -repository=ftp://tug.org/historic/systems/texlive/2020/tlnet-final/ \
    && cd /texlive \
