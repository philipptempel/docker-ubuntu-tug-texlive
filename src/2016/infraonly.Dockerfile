...
ADD --chown=latex:latex 2016/texlive.profile /texlive/texlive.profile
RUN mkdir /latex \
...
RUN cd /texlive/ \
    ...
    && cd install-tl-*/ \
    && ./install-tl -profile=/tmp/texlive/texlive.profile -repository=ftp://tug.org/historic/systems/texlive/2016/tlnet-final/ \
    && cd /texlive \
